...
<img src="/static/img/zdxx.png" width="500"/>

上图描述了一个数组被递归拆分的过程，除此之外，在程序回溯的时候，一次保证数组有序，如下图：

<img src="/static/img/hsyx.png" width="500"/>
...
<img style="margin-left: 20px;" src="/static/img/3468915251-591982ece300e_articlex.gif" width="350" />
