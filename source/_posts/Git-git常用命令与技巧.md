---
title: Git-git常用命令与技巧
date: 2018-04-17 16:29:09
tags: [Git,API]
category: "Git"
---
## git常用命令及技巧
...
<img src="/static/img/git-merge.png" width="200" />

所以为了保留分支的 `commit` 历史记录，我们可以采用 `--no-ff` 选项，这样合并后的历史记录图类似于这样：

<img src="/static/img/git-merge-noff.png" width="200" />

#### git merge --squash

`--squash` 选项用于压缩多个“无用”的 `commit` 为一个 `commit`，效果类似下图：

<img src="/static/img/git-merge-squash.png" width="200" />